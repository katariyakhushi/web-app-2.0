...
class Section extends Component {
    render() {
        return (
            <React.Fragment>
                <section className="hero-4-bg position-relative bg-light" id="home"
                        ...
                        <Row className="align-items-center justify-content-center">
                            <Col lg="6">
                                <div className="">
                                    ...
                                    <h1 className="hero-4-title mb-4 line-height-1_4">We Craft Digital, Graphic and
                                        Dimensional Thinking</h1>
                                    <p className="text-muted mb-4 pb-3">Nemo enim ipsam voluptatem quia voluptas sit
                                        aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui
                                        ratione sequinesciunt.</p>
                                    <Link to="#" className="btn btn-primary">Get Started <span
                            ...
                            <Col lg={4} className="offset-lg-2 col-md-8">
                                <div className="hero-login-form mx-auto bg-white shadow p-4 rounded mt-5 mt-lg-0">
                                    <div className="text-center">
                                        <p className="text-muted mb-2 f-13 text-uppercase">Welcome To Kisano Ka Apna Bazar</p>
                                    ...
                                    <Form>
                                        ...
                                        <Button type="submit" color="primary"
                                                className="btn btn-primary btn-block btn-sm">Get Started <i
                                            className="mdi mdi-telegram ml-2"></i></Button>
                                    </Form>
                                </div>
                            </Col>
                        </Row>
