                        ...
                        <Row className="justify-content-center">
                            <Col lg="6">
                                <div className="text-center">
                                    <span
                                        className="badge bg-soft-light text-white-70 f-15 mb-4">Creative Landing Page</span>
                                    <h1 className="hero-2-title mb-4 text-white">Make Your Site Amazing & Unique</h1>
                                    <p className="text-white-50 mb-4 pb-3">Nemo enim ipsam voluptatem quia voluptas sit
                                        aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui
                                        ratione sequinesciunt.</p>
                                    <Link to="#" className="btn btn-light">Get Started <span
