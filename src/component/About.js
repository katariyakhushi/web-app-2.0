            ...
            <React.Fragment>
                <section className="section" id="about">
                    <Container>
                        ...
                        <Row>
                            <Col lg={6}>
                                <span className="font-weight-medium">किसानों का अपना बाजार शाजापुर से स्टार्ट हुआ एक संस्थान है जो किसानों को खाद बीज दवाई एग्री एक्सपर्ट के माध्यम से
                                    ...
                                    सामने नरसिंह रोड पर है</span>
                                <br/>
                                <br/>
                                <br/>

                                <p className="f-17 text-muted"><FeatherIcon
                                    className="icon-xs text-primary icon-fill-primary icon mr-2" icon="grid"/> Marketing
                                    program activities</p>
                                <p className="f-17 text-muted"><FeatherIcon
                                    className="icon-xs text-primary icon-fill-primary icon mr-2"
                                    icon="layout"/> Customization product</p>
                                <p className="f-17 text-muted mb-4"><FeatherIcon
                                    className="icon-xs text-primary icon-fill-primary icon mr-2" icon="monitor"/> At
                                    vero eos accusamus iusto</p>
                            ...
                            <Col lg={4}>
                                <div className="card border-0">
                                    ...
                                    <div className="mt-3">
                                        ...
                                        <p className="text-muted">Temporibus autem quibusdam a officiis debitis aut
