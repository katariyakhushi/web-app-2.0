                            ...
                            <div className="col-lg-7">
                                <div className="text-center mb-5">
                                    ...
                                    <p className="text-muted">
                                        "Kisano Ka Apna Bazar team is dedicated to bringing social awareness among the farmers and ensuring visits to villages regarding the products farmers use."
                                    </p>
                                </div>
                            </div>
                        </Row>
                        <Row>
                            {this.state.images.map((item, key) => (
                                <Col lg={4} md={6} key={key}>
                                    <div className="project-box mb-4 gallery-box">
                                        <div className="position-relative overflow-hidden rounded">
                                            <img
                                                src={item.img}
                                                alt=""
                                                className="img-fluid d-block mx-auto shadow gallery-img"
                                            />
                                            <div className="project-overlay">
                                                <div className="project-content">
                                                    <div className="project-icon" style={{ cursor: "pointer" }}>
                                                        <a href={item.img} style={{ textDecoration: "none" }}>
                                                            <i>
                                                                <FeatherIcon icon="zoom-in" size={40} />
                                                            </i>
                                                        </a>
                                                    </div>
                                                </div>
